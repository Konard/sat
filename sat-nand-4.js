...
function evaluateFormula(formula, assignment) {
  ...
  function parseExpression(expr) {
    ...
    // Check for parentheses to handle expressions like '(expr)'
  ...
  // Function to find the main operator index, considering nested expressions
...
function testSmallFormulas() {
  const testCases = [
    ...
    {
      formula: '((arg_1 ↑ arg_1) ↑ arg_1) ↑ ((arg_1 ↑ arg_1) ↑ arg_1)', // (NOT arg_1) AND arg_1, unsatisfiable
